...
public class SupportTwo extends AbstractPivotPoint {
     ...
     * @see PivotPoint
     */
    public SupportTwo(List<TimeSeries> data, PivotPoint pivotPoint) {
        super(data);
    ...
    protected TADecimal calculate(int i) {
        ...
        if (pivotPointValue != null && prevLow != null && prevHigh != null) {
            return pivotPointValue.minus((prevHigh.minus(prevLow)));
        }
        return null;
    }
}
